...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 25-08-2019 a las 19:42:51
...
(1, 2, 13, 'Formulario Visto Nazionale.pdf', 10, 3),
(2, 3, 13, 'CV.pdf', 8, 3),
(3, 2, 14, 'Individual reflection.pdf', 7, 3),
(4, 3, 14, 'curp.pdf', 5, 3),
(5, 2, 15, '', 0, 0),
(6, 3, 15, '', 0, 0),
(7, 2, 16, '', 0, 0),
(8, 3, 16, '', 0, 0),
(9, 2, 17, 'Individual reflection.pdf', 8, 3),
(10, 3, 17, '', 0, 0);
...
CREATE TABLE `calificaciones` (
  ...
  `tareasComp` double(10,2) NOT NULL,
...
INSERT INTO `calificaciones` (`id`, `fk_student`, `id_pm`, `tareas`, `tareasComp`, `examen`, `calificacion`, `estatus`) VALUES
(4, 2, 100001, 15, 5.00, 65, 85, 1),
(5, 3, 100001, 7.8, 10.00, 50, 67.8, 1),
(6, 2, 100003, 30, 5.00, 50, 85, 1);
...
INSERT INTO `profesor_materia` (`id_pm`, `profesor`, `materia`, `grupo`, `estatus`, `porcentaje`) VALUES
(100001, 901, 1, '1CM5', 1, 18),
(100003, 902, 7, '3CV4', 1, 25),
(100004, 902, 2, '8CM10', 1, 30);
...
(15, 'Investigación de la revolución mexicana', '1970-01-01', '1970-01-01', 10, '', 1, 100003),
(16, 'Reporte 2', '1970-01-01', '2019-06-09', 10, '', 1, 100003),
(17, 'Tarea 3', '1970-01-01', '2019-07-09', 10, '', 1, 100001);
