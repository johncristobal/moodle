                ...
                <div class="col-12 col-sm-6 backGray">
                    ...
                    <div class="row text-center">
                        <div class="col-12 text-center">
                            <img src="http://localhost/Moodle//images/usericon.jpg" class="img-rounded" width="100" height="100">
                        </div>
                    </div>
                    <br>
            ...
            <form id="formularioEditarInfo" method="post" enctype="multipart/form-data">
              <div class="modal-body">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-8 input-group date" data-provide="datepicker" data-date-format="dd/mm/yyyy" language="es">
